...
const ACTIVITY_LABELS: Record<string, string> = {
  ...
  CERTIFICATE_PDF_GENERATED: "Certificate PDF generated",
  CERTIFICATE_PRINTED_AND_RELEASED: "Certificate printed and released",
  REQUEST_REJECTED: "Request rejected",
  REQUEST_RETURNED: "Request returned",
  REQUEST_RELEASED: "Request released",
  REQUEST_DELIVERY_FAILED: "PDF generation failed",
  CERTIFICATE_RELEASED_AND_EMAILED: "Certificate released; ready for pickup",
  CERTIFICATE_RELEASED_EMAIL_NOT_SENT: "Certificate released; ready for pickup",
  CERTIFICATE_APPROVED_AND_RELEASED_PDF_DOWNLOAD: "Certificate released; ready for pickup",
  CERTIFICATE_DELIVERY_FAILED: "Certificate PDF generation failed",
...
async function buildActivityFeed(db: DatabaseClient): Promise<StaffDashboardActivityItem[]> {
  const activityRows = await loadAuditRows(
    ...
    [
      ...
      "CERTIFICATE_PRINTED_AND_RELEASED",
      "REQUEST_REJECTED",
      "REQUEST_RETURNED",
      "REQUEST_RELEASED",
      ...
      "CERTIFICATE_APPROVED_AND_RELEASED_PDF_DOWNLOAD",
