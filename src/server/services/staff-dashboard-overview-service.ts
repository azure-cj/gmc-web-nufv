...
const ACTIVITY_LABELS: Record<string, string> = {
  ...
  CERTIFICATE_RELEASED_AND_EMAILED: "Certificate released",
  CERTIFICATE_RELEASED_EMAIL_NOT_SENT: "Certificate released; PDF available for download",
  CERTIFICATE_APPROVED_AND_RELEASED_PDF_DOWNLOAD: "Certificate released; PDF ready for download",
